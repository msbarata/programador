        ...
        public void run(){
         ...
         while(true) {
             ...
             if (numero <= 0){
                     ...
                     jLabel1.setForeground(new java.awt.Color (numero, numero, numero));
                     jPanel1.setBackground(new java.awt.Color (254-numero, 254-numero, 254-numero));
                     
                     
                       try {Thread.sleep(100);}
                       catch (Exception ex) {System.out.println("problema");}
                    }
              }       
