...
public:
    ...
    void menuStatusONG() const {
        cout << "=== ONGS (Preservação da Floresta) ===" << endl;
        cout << "Nome: " << nomeONG << endl;
        cout << "Palestras realizadas: " << palestrasRealizadas << endl;
        cout << "Árvores plantadas: " << arvoresPlantadas << endl;
        cout << "\033[32m" << "BÔNUS - PARTILHA DO CONHECIMENTO: " << bonusXP << endl;
        cout << "BÔNUS - VIDA NO PLANETA: " << bonusHP << "\033[0m" << endl;
        cout << "===============" << endl;
    }
    ...
    void realizarPalestra(Personagem &j) {
        ...
        cout << "Tema: Prevenção de Incêndios e Proteção Florestal" << "\033[0m" << endl << endl;
        sleep(1);
        ...
        cout << "   Total de palestras da ONG: " << palestrasRealizadas << endl;
         cout << "================================================================" << endl;
        cout << "**##** Parabéns você concluiu mais uma etapa!! **##** 'DIGITE ENTER' " << endl;
        cout << "================================================================" << endl;
    ...
    void mutiraoPlantio(Personagem &j) {
        ...
        cout << "Voluntários prontos para plantar árvores nativas portuguesas" << "\033[0m" << endl << endl;
        sleep(1);
...
void fase1Combate(Personagem &j, Personagem &m, int &rondas){
    ...
    cout << "=== FASE 1: DETECCÃO PRECOCE ===" << endl << endl;
        cout << "\033[32m" << R"(  "Você é um 'Bombeiro Voluntário' - vigia estradas e torres de vigilância para identificar fogos nas florestas,
        provocados por inúmeros fatores ..."
          ___
         /   \
        | O O |
         \___/
   ...
   cout << "=== DIGITE - ENTER (para continuar) ===" << endl;
    ...
    if(j.getHP() <= 0){
        cout << "\033[35m" << "DERROTA NA FASE 1! Os Fogos se alastram pela floreta e os bombeiros ainda não chegaram ao local!" << endl;
    }
    else{
        cout << "VITÓRIA NA FASE 1! Os Bombeiros da Capital chegam ao local rapidamente e controlam o incêndio!" << "\033[0m" << endl;
    }
...
void fase2Imobilizacao(Personagem &j, Personagem &m, int &rondas){
    ...
    cout << "\033[32m" << R"( "Você é um 'Bombeiro Voluntário' - Agora em conjunto com colegas
    voluntários, vocês passam a explorar locais florestais, seja a pé ou com o auxílio de drones,
    a mapear e registar perigos e rotas seguras..."
          ___
         /   \
        | O O |
         \___/
   ...
   cout << "=== DIGITE - ENTER (para continuar) ===" << endl; 
    ...
    if(j.getHP() <= 0){
        ...
        cout << "VITÓRIA NA FASE 2! Você e seus colegas 'Bombeiros Voluntários' conseguiram mapear o local e contribuiu com o controle dos fogos!" << "\033[0m" << endl;
    }
...
void fase3Autoridades(Personagem &j, Personagem &m, int &rondas){
    ...
    cout << "\033[32m" << R"( Após alguns fogos apagados, surge mais um novo foco de incêndio 'pequeno',
    mas que necessita de uma ação rápida, pois já está a ameaçar 'Moradas'! Você e colegas 'Bombeiros Voluntários'
    precisam inciar imediatamente ação de combate ao fogo, com as ferramentas e recursos que tiverem disponíveis!!
           ___
         /   \
        | O O |
         \___/
   ...
   clear();
    ...
    if(j.getHP() <= 0){
        cout << "\033[35m" << "DERROTA NA FASE 3! Apesar de todos os esforços dos 'Bombeiros Voluntários' os fogos florestais continuam a se alastrar!" << endl;
    }
    else{
        cout << "VITÓRIA NA FASE 3! Você e seus colegas 'Bombeiros Voluntários' conseguiram! controlaram os fogos rapidamente por meio dos recursos limitados que possuíam!" << "\033[0m" << endl;
    }
...
void fase4Aceiros(Personagem &j, Personagem &m, int &rondas){
    ...
    cout << "=== FASE 4: CONSTRUCÃO DE ACEIROS ===" << endl << endl;
     ...
     cout << "\033[32m" << R"( Após o devido mapeamento do terreno, realizada por você e sua dedicada equipa!,
     Você e os 'Bombeiros Voluntários' precisam ainda, abrir aceiros, caves e valas corta-fogo, com o auxílio
     de tratores e outras ferramentas disponíveis, para fins de evitar o alastramento dos fogos.
          ___
         /   \
        | O O |
         \___/
   ...
   cout << "=== DIGITE - ENTER (para continuar) ===" << endl; 
    ...
    if(j.getHP() <= 0){
        cout << "DERROTA NA FASE 4! Apesar de todo o seu esforço conjunto com os bombeiros sepadores, os fogos florestais continuam a se alastrar!" << endl;
    }
    else{
        cout << "VITÓRIA NA FASE 4! Você conseguiu controlar os fogos florestais!! por meio das valas corta-fogo, feitas por meio de tratores e pá !" << endl;
        cout << "Digite Enter para continuar..." << endl;
    }
...
void resultFinal(Personagem &j, Personagem &m, int &rondas){
    if (j.getHP() <= 0){
        ...
        cout << "\033[32m" << "VITÓRIA!!! Finalmente, você derrotou os FOGOS FLORESTAIS e protegeu a floresta portuguesa." << endl;
        cout << "De acordo com as leis portuguesas contra fogos, ações como essa salvam vidas e ecossistemas! Por isso, você ganhou " << xpGanho << " extras por sua coragem! 🦁 " << "\033[0m" << endl << endl;
        j.addXP(xpGanho);
...
void mensagemTransicao(int numeroFase) {
    cout << "================================================================" << endl;
    cout << "**##** Você avança para a Fase " << numeroFase << "! **##** 'DIGITE ENTER' " << endl;
    cout << "================================================================" << endl;
    sleep(3);
}
...
int exibirMenu() {
    ...
    cout << "=== ETAPA 2 - COLABORADOR DA ONG - 'GUARDIÕES VERDES' ===" << endl;
    cout << "5. FASE 5 - Realizar Palestra nas Juntas (🎓)" << endl;
    cout << "6. FASE 6 - Organizar Mutirão de Plantio (🌱 )" << endl << endl;
    cout << "=== JOGO COMPLETO - VOLUNTÁRIO E COLABORADOR-ONG" << endl;
...
void finalizarJogo(Personagem &j, Personagem &m, ONG &ong, int rondas) {
    clear();
