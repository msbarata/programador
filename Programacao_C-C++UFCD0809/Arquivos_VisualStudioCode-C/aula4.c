...
void adivinha(){
    ...
    if (palpite == numeroSecreto){
        printf("\nParabéns você venceu!! Acertou o número secreto! \n");
        printf("O seu número de tentativas foi:  %d",tentativas); break;
        
    }else if (palpite < numeroSecreto){
        printf("\nValor do palpite muito baixo!! digite um valor maior: \n");
    }else if (palpite > numeroSecreto){
        printf("\nValor do palpite muito alto!! digite um valor menor: \n");
...
int main(){
   ...
   while(sleep(4),cls(),boasVindas(),scanf("%d", &opcao)){
        switch(opcao){
            ...
            case 1: printf("O Seu IMC é de: %lf\n",imc(peso,altura)); break;
            case 2: printf("A conversão de milhas em KM deu: %.2lfkm\n",mkm(m)); break;
            case 3: printf("A regra de três simples devolveu: %.2lf\n",tres(a,b,c)); break;
            case 4: printf("Jogo da Adivinha: \n");adivinha(); break;
            case 5: printf("A raiz quadra devolveu: %.2lf\n",raiz(a)); break;
            ...
            case 8: printf("O MDC entre os dois números informados devolveu: %.2d\n",mdc(x,y)); break;
